...
class default_model:
    ...
    def all(cls):
        ...
        results = connectToMySQL('fantasy_soccer').query_db(query)
    ...
    def find_by_id(cls, id):
        try:
            ...
            result = connectToMySQL('fantasy_soccer').query_db(query)
    ...
    def save(cls, data):
        ...
        return connectToMySQL('fantasy_soccer').query_db(query, data)
    ...
    def delete_by_id(cls, id):
        ...
        return connectToMySQL('fantasy_soccer').query_db(query)
